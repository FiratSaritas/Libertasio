...
* Enhanced cookie consent banner with granular settings
*/
...
const translations = {
  ...
  it: {
    text: "Utilizziamo i cookie per personalizzare contenuti e annunci, fornire funzionalità dei social media e analizzare il nostro traffico. Le informazioni sull'utilizzo del sito sono condivise con i nostri partner di social media, pubblicità e analisi. <a href='/myself2/privacy' class='cookie-learn-link'>Scopri di più</a>.",
    accept: "Accetta tutto",
    customize: "Impostazioni",
    reject: "Usa solo cookie necessari",
    settingsText: "Qui puoi modificare le tue preferenze sui cookie:",
    analyticsLabel: "Cookie di analisi",
    analyticsDesc: "Raccoglie dati tecnici sull'uso per migliorare il sito.",
    marketingLabel: "Cookie di marketing",
    marketingDesc: "Consentono pubblicità personalizzate e misurazione delle campagne."
  },
  fr: {
    text: "Nous utilisons des cookies pour personnaliser le contenu et les publicités, offrir des fonctionnalités de médias sociaux et analyser notre trafic. Les informations sur votre utilisation de notre site sont partagées avec nos partenaires de médias sociaux, de publicité et d’analyse. <a href='/myself2/privacy' class='cookie-learn-link'>En savoir plus</a>.",
    ...
    analyticsDesc: "Collecte des données techniques pour améliorer le site.",
    marketingLabel: "Cookies marketing",
    marketingDesc: "Permettent la publicité personnalisée et la mesure des campagnes."
  }
};
...
function injectBanner() {
  ...
  <div id="cookie-banner">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:1rem;">
      <div style="flex:1;">
        ...
        <p id="cookie-text" style="margin:0.5rem 0;">Wir verwenden Cookies, um Inhalte und Anzeigen zu personalisieren ... 
        <a href="/myself2/privacy" class="cookie-learn-link">Mehr erfahren</a>.</p>
      </div>
  ...
  <button id="cookie-button" onclick="reopenConsentBanner()">🍪</button>
  `;
...
window.addEventListener('DOMContentLoaded',()=>{
  ...
  if(!stored){document.getElementById('cookie-banner').style.display='block';switchLang('de');}
  else{document.getElementById('cookie-button').style.display='block';if(stored==='granted')loadGTM();}
});
</script>
